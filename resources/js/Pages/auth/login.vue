...
<template>
    <GuestLayout>
        ...
        <p class="mt-10 text-sm font-light text-gray-500 dark:text-gray-400">
            ...
            <Link href="/register" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none">Register</Link>
        </p>
    </GuestLayout>
</template>
